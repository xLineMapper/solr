...
public class JSONResponseWriterArch extends AbstractMyxSimpleBrick implements IJSONResponseWriter
{
    public static final IMyxName msg_IJSONResponseWriter = MyxUtils.createName("edu.umkc.type.tmpl.IJSONResponseWriter");


	private IJSONResponseWriterImp _imp;

    public JSONResponseWriterArch (){
    ...
    protected IJSONResponseWriterImp getImplementation(){
        try{
			return new JSONResponseWriterImp();    
        } catch (Exception e){
	...
	public Object getServiceObject(IMyxName arg0) {
		if (arg0.equals(msg_IJSONResponseWriter)){
			return this;
		}        
		return null;
	}
