...
public class DumpRequestHandlerPluginImp implements IDumpRequestHandlerPluginImp
{
	private DumpRequestHandlerPluginArch _arch;

    public DumpRequestHandlerPluginImp (){
    }
  ...
  public void begin(){
	...
	*/
	private final String pluginName = "DumpRequestHandler";
