...
public class InfoHandlerPluginImp implements IInfoHandlerPluginImp
{
	private InfoHandlerPluginArch _arch;

    public InfoHandlerPluginImp (){
    }
  ...
  public void begin(){
	...
	*/
	private final String pluginName = "InfoHandler";
