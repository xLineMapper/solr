...
public class ThreadDumpHandlerPluginImp implements IThreadDumpHandlerPluginImp
{
	private ThreadDumpHandlerPluginArch _arch;

    public ThreadDumpHandlerPluginImp (){
    }
  ...
  public void begin(){
	...
	*/
	...
	private final String pluginName = "ThreadDumpHandler";
