...
public class SortingResponseWriterImp implements ISortingResponseWriterImp, ISortingResponseWriter
{
	private SortingResponseWriterArch _arch;
	
  public SortingResponseWriterImp (){
  }
  
	public void setArch(SortingResponseWriterArch arch){
		_arch = arch;
	}
	
	public SortingResponseWriterArch getArch(){
		return _arch;
	}
  ...
  private final static Logger logger = LoggerFactory.getLogger(SortingResponseWriterImp.class);
