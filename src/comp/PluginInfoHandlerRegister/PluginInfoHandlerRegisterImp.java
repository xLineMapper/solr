...
public class PluginInfoHandlerRegisterImp implements IPluginInfoHandlerRegisterImp
{
	private PluginInfoHandlerRegisterArch _arch;

  public PluginInfoHandlerRegisterImp (){
  }
  ...
  {
    implicits.add(ImplicitPluginsImp.getReqHandlerInfo("/admin/plugins", PluginInfoHandler.class, null));		
  }
}