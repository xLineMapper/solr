...
public class LukeRequestHandlerRegisterImp implements ILukeRequestHandlerRegisterImp
{
	private LukeRequestHandlerRegisterArch _arch;

  public LukeRequestHandlerRegisterImp (){
  }
  ...
  {
    implicits.add(ImplicitPluginsImp.getReqHandlerInfo("/admin/luke", LukeRequestHandler.class, null));
  }
}