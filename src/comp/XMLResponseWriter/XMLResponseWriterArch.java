...
public class XMLResponseWriterArch extends AbstractMyxSimpleBrick implements IXMLResponseWriter
{
    public static final IMyxName msg_IXMLResponseWriter = MyxUtils.createName("edu.umkc.type.tmpl.IXMLResponseWriter");


	private IXMLResponseWriterImp _imp;

    public XMLResponseWriterArch (){
    ...
    protected IXMLResponseWriterImp getImplementation(){
        try{
			return new XMLResponseWriterImp();    
        } catch (Exception e){
	...
	public Object getServiceObject(IMyxName arg0) {
		if (arg0.equals(msg_IXMLResponseWriter)){
			return this;
		}        
		return null;
	}
