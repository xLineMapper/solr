...
public class MoreLikeThisHandlerPluginImp implements IMoreLikeThisHandlerPluginImp
{
	private MoreLikeThisHandlerPluginArch _arch;

    public MoreLikeThisHandlerPluginImp (){
    }
  ...
  public void begin(){
	...
	*/
	private final String pluginName = "MoreLikeThisHandler";
