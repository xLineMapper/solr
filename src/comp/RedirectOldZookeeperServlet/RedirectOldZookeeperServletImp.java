...
public class RedirectOldZookeeperServletImp implements IRedirectOldZookeeperServletImp
{
	private RedirectOldZookeeperServletArch _arch;
	
	final private RedirectServlet servlet;

  public RedirectOldZookeeperServletImp (){
