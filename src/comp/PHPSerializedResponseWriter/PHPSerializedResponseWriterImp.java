...
public class PHPSerializedResponseWriterImp implements IPHPSerializedResponseWriterImp, IPHPSerializedResponseWriter
{
	private PHPSerializedResponseWriterArch _arch;
	
  public PHPSerializedResponseWriterImp (){
  }
  
	public void setArch(PHPSerializedResponseWriterArch arch){
		_arch = arch;
	}
	
	public PHPSerializedResponseWriterArch getArch(){
		return _arch;
	}
