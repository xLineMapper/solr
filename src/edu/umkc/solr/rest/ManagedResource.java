...
public abstract class ManagedResource {
  ...
  protected final ISolrResourceLoader solrResourceLoader;
   ...
   */
  protected ManagedResource(String resourceId, ISolrResourceLoader loader, StorageIO storageIO)
   ...
   */
  protected ManagedResourceStorage createStorage(StorageIO storageIO, ISolrResourceLoader loader) 
      throws SolrException {
