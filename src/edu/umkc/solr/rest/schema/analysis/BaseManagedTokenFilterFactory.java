...
import edu.umkc.solr.rest.ManagedResourceObserver;
  ...
  implements ResourceLoaderAware, ManagedResourceObserver
{
   ...
   * resources the {@link edu.umkc.solr.rest.RestManager} needs to initialize
  ...
  public void inform(ResourceLoader loader) throws IOException {
    ISolrResourceLoader solrResourceLoader = (ISolrResourceLoader)loader;
