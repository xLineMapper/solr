package edu.umkc.solr.spelling;
/*
...
import edu.umkc.solr.handler.component.SpellCheckMergeData;
...
public abstract class SolrSpellChecker {
   ...
   */
  public abstract void reload(ISolrCore core, SolrIndexSearcher searcher) throws IOException;

  /**
   * (re)Builds the spelling index.  May be a NOOP if the implementation doesn't require building, or can't be rebuilt.
   */
  public abstract void build(ISolrCore core, SolrIndexSearcher searcher) throws IOException;
