...
import comp.SolrDispatchFilter.SolrDispatchFilterImp;
  ...
  private void init(int port) {
    ...
    server.addLifeCycleListener(new LifeCycle.Listener() {
      ...
      public void lifeCycleStarted(LifeCycle arg0) {
        ...
        root.getServletContext().setAttribute(SolrDispatchFilterImp.PROPERTIES_ATTRIBUTE, nodeProperties);
        root.getServletContext().setAttribute(SolrDispatchFilterImp.SOLRHOME_ATTRIBUTE, solrHome);
        ...
        dispatchFilter = root.addFilter(SolrDispatchFilterImp.class, "*", EnumSet.of(DispatcherType.REQUEST) );
