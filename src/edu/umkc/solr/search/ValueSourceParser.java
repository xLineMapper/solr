...
import edu.umkc.solr.schema.CurrencyField;
...
import edu.umkc.solr.search.facet.AggValueSource;
import edu.umkc.solr.search.facet.AvgAgg;
import edu.umkc.solr.search.facet.CountAgg;
import edu.umkc.solr.search.facet.HLLAgg;
import edu.umkc.solr.search.facet.MaxAgg;
import edu.umkc.solr.search.facet.MinAgg;
import edu.umkc.solr.search.facet.PercentileAgg;
import edu.umkc.solr.search.facet.SumAgg;
import edu.umkc.solr.search.facet.SumsqAgg;
import edu.umkc.solr.search.facet.UniqueAgg;
import edu.umkc.solr.search.function.CollapseScoreFunction;
import edu.umkc.solr.search.function.OrdFieldSource;
import edu.umkc.solr.search.function.ReverseOrdFieldSource;
import edu.umkc.solr.search.function.distance.GeoDistValueSourceParser;
import edu.umkc.solr.search.function.distance.GeohashFunction;
import edu.umkc.solr.search.function.distance.GeohashHaversineFunction;
import edu.umkc.solr.search.function.distance.HaversineFunction;
import edu.umkc.solr.search.function.distance.SquaredEuclideanFunction;
import edu.umkc.solr.search.function.distance.StringDistanceFunction;
import edu.umkc.solr.search.function.distance.VectorDistanceFunction;
