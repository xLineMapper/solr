    ...
    return new QParser(qstr, localParams, params, req) {
      ...
      public Query parse() throws SyntaxError {
        ...
        if (fromIndex != null && !fromIndex.equals(req.getCore().getCoreDescriptor().getName()) ) {
          ICoreContainer container = req.getCore().getCoreDescriptor().getCoreContainer();
          ...
          final ISolrCore fromCore = container.getCore(fromIndex);
          if (fromCore == null)
            throw new SolrException(SolrException.ErrorCode.BAD_REQUEST,
  ...
  private class JoinQueryWeight extends ConstantScoreWeight {
    ...
    public JoinQueryWeight(SolrIndexSearcher searcher) {
      ...
      if (fromIndex == null) {
        ...
        ICoreContainer container = searcher.getCore().getCoreDescriptor().getCoreContainer();
        final ISolrCore fromCore = container.getCore(fromIndex);
