...
public class DisMaxQParser extends QParser {
  ...
  public static String parseMinShouldMatch(final IndexSchema schema, 
    ...
    edu.umkc.solr.parser.QueryParser.Operator op = QueryParsing.getQueryParserDefaultOperator
   ...
   * or {@link edu.umkc.solr.schema.IndexSchema#getDefaultSearchFieldName()}.
   */
