...
import comp.SolrIndexSearcherFactory.SolrIndexSearcherFactoryImp.SolrIndexSearcher.QueryCommand;
...
public abstract class StatsCache implements PluginInfoInitialized {
   ...
   */
  public static final String TERM_STATS_KEY = "edu.umkc.solr.stats.termStats";
  /**
   * Value of {@link CollectionStats}.
   */
  public static final String COL_STATS_KEY = "edu.umkc.solr.stats.colStats";
  /**
   * List of terms in the query.
   */
  public static final String TERMS_KEY = "edu.umkc.solr.stats.terms";
