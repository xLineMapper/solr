...
import edu.umkc.solr.schema.StrFieldSource;
import edu.umkc.solr.search.grouping.collector.FilterCollector;
...
public class Grouping {
   ...
   * {@link #addFunctionCommand(String, edu.umkc.solr.request.SolrQueryRequest)} method.
   *
