 ...
 */
package edu.umkc.solr.highlight;
...
public class DefaultSolrHighlighter extends SolrHighlighter implements PluginInfoInitialized
{
  ...
  protected final ISolrCore solrCore;

  //Will be invoked via reflection
  public DefaultSolrHighlighter(ISolrCore solrCore) {
  ...
  public NamedList<Object> doHighlighting(DocList docs, Query query, SolrQueryRequest req, String[] defaultFields) throws IOException {
    ...
    for (int i = 0; i < docs.size(); i++) {
      ...
      for (String fieldName : fieldNames) {
        ...
        } else if (schemaField.getType() instanceof edu.umkc.solr.schema.TrieField) {
