...
public class SnapShooter {
  ...
  private ISolrCore solrCore;
  private String snapshotName = null;
  private String directoryName = null;
  private File snapShotDir = null;

  public SnapShooter(ISolrCore core, String location, String snapshotName) {
    solrCore = core;
    if (location == null) {
      ...
      snapDir = edu.umkc.solr.util.FileUtils.resolvePath(base, location).getAbsolutePath();
    }
