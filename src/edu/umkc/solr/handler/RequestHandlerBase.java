...
import edu.umkc.solr.handler.component.SearchHandler;
...
import edu.umkc.solr.util.stats.Snapshot;
import edu.umkc.solr.util.stats.Timer;
import edu.umkc.solr.util.stats.TimerContext;

import java.net.URL;
import java.util.concurrent.atomic.AtomicLong;

import static edu.umkc.solr.core.RequestParams.USEPARAM;
...
public abstract class RequestHandlerBase implements SolrRequestHandler, SolrInfoMBean, NestedRequestHandler {
  ...
  /**
   * Initializes the {@link edu.umkc.solr.request.SolrRequestHandler} by creating three {@link org.apache.solr.common.params.SolrParams} named.
   ...
   *
   * @see #handleRequest(edu.umkc.solr.request.SolrQueryRequest, edu.umkc.solr.response.SolrQueryResponse)
   * @see #handleRequestBody(edu.umkc.solr.request.SolrQueryRequest, edu.umkc.solr.response.SolrQueryResponse)
   * @see edu.umkc.solr.util.SolrPluginUtils#setDefaults(edu.umkc.solr.request.SolrQueryRequest, org.apache.solr.common.params.SolrParams, org.apache.solr.common.params.SolrParams, org.apache.solr.common.params.SolrParams)
