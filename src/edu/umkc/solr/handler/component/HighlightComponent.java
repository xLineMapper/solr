...
import edu.umkc.solr.highlight.DefaultSolrHighlighter;
import edu.umkc.solr.highlight.PostingsSolrHighlighter;
...
public class HighlightComponent extends SearchComponent implements PluginInfoInitialized, SolrCoreAware
{
  ...
  public static SolrHighlighter getHighlighter(ISolrCore core) {
