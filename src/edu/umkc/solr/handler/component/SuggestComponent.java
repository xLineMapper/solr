...
import edu.umkc.solr.spelling.suggest.SolrSuggester;
import edu.umkc.solr.spelling.suggest.SuggesterOptions;
import edu.umkc.solr.spelling.suggest.SuggesterParams;
import edu.umkc.solr.spelling.suggest.SuggesterResult;
...
public class SuggestComponent extends SearchComponent implements SolrCoreAware, SuggesterParams, Accountable {
  ...
  private void reloadSuggester(SolrSuggester suggester, ISolrCore core,
  ...
  private static class SuggesterListener implements SolrEventListener {
    ...
    public SuggesterListener(ISolrCore core, SolrSuggester checker, boolean buildOnCommit, boolean buildOnOptimize, boolean buildOnStartup, boolean isCoreReload) {
      this.core = core;
