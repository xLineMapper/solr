...
public class SystemInfoHandler extends RequestHandlerBase 
{
  ...
  public SystemInfoHandler(ICoreContainer cc) {
    super();
    this.cc = cc;
    init();
  }
  ...
  private ICoreContainer getCoreContainer(SolrQueryRequest req, ISolrCore core) {
    ICoreContainer coreContainer;
    if (core != null) {
   ...
   * Get system info
   */
  private SimpleOrderedMap<Object> getCoreInfo( ISolrCore core, IndexSchema schema ) {
