...
public abstract class SolrQueryRequestBase implements SolrQueryRequest, Closeable {
  protected final ISolrCore core;
  ...
  public SolrQueryRequestBase(ISolrCore core, SolrParams params, RTimer requestTimer) {
    this.core = core;
  ...
  public SolrQueryRequestBase(ISolrCore core, SolrParams params) {
