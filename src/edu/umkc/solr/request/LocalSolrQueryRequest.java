...
public class LocalSolrQueryRequest extends SolrQueryRequestBase {
  ...
  public LocalSolrQueryRequest(ISolrCore core, String query, String qtype, int start, int limit, Map args) {
    super(core,makeParams(query,qtype,start,limit,args));
  }

  public LocalSolrQueryRequest(ISolrCore core, NamedList args) {
    super(core, SolrParams.toSolrParams(args));
  }

  public LocalSolrQueryRequest(ISolrCore core, Map<String,String[]> args) {
    super(core, new MultiMapSolrParams(args));
  }
  
  public LocalSolrQueryRequest(ISolrCore core, SolrParams args) {
    super(core, args);
  }
