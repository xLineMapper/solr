...
/**
 * A CoordinateFieldType is the base class for {@link edu.umkc.solr.schema.FieldType}s that have semantics
 * related to items in a coordinate system.
 * <br>
 * Implementations depend on a delegating work to a sub {@link edu.umkc.solr.schema.FieldType}, specified by
