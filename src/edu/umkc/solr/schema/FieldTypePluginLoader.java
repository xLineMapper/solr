...
import edu.umkc.solr.util.plugin.AbstractPluginLoader;
...
public final class FieldTypePluginLoader 
  ...
  @Override
  protected FieldType create( ISolrResourceLoader loader, 
                              String name, 
                              String className, 
  ...
  private Analyzer readAnalyzer(Node node) throws XPathExpressionException {
    ...
    final ISolrResourceLoader loader = schema.getResourceLoader();
    ...
    AbstractPluginLoader<CharFilterFactory> charFilterLoader =
      ...
      @Override
      protected CharFilterFactory create(ISolrResourceLoader loader, String name, String className, Node node) throws Exception {
    ...
    AbstractPluginLoader<TokenizerFactory> tokenizerLoader =
      ...
      @Override
      protected TokenizerFactory create(ISolrResourceLoader loader, String name, String className, Node node) throws Exception {
        final Map<String,String> params = DOMUtil.toMap(node.getAttributes());
        String configuredVersion = params.remove(LUCENE_MATCH_VERSION_PARAM);
    ...
    {
      @Override
      protected TokenFilterFactory create(ISolrResourceLoader loader, String name, String className, Node node) throws Exception {
        final Map<String,String> params = DOMUtil.toMap(node.getAttributes());
        String configuredVersion = params.remove(LUCENE_MATCH_VERSION_PARAM);
