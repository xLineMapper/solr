...
public class ManagedIndexSchemaFactory extends IndexSchemaFactory implements SolrCoreAware {
  ...
  private ISolrResourceLoader loader;
  public ISolrResourceLoader getResourceLoader() { return loader; }
   ...
   * {@link SolrResourceLoaderImp#getConfigDir()}, or if configs are
   * in ZooKeeper, under {@link edu.umkc.solr.cloud.ZkSolrResourceLoader#configSetZkPath}.
   *
