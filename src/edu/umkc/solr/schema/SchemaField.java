...
public final class SchemaField extends FieldProperties {
 ...
 /** Create a new SchemaField with the given name and type,
   ...
   * @param ft The {@link edu.umkc.solr.schema.FieldType} of the field
   * @param props The props.  See {@link #calcProps(String, edu.umkc.solr.schema.FieldType, java.util.Map)}
