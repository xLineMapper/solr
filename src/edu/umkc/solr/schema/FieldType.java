...
import edu.umkc.solr.analysis.SolrAnalyzer;
import edu.umkc.solr.analysis.TokenizerChain;
import edu.umkc.solr.response.TextResponseWriter;
import edu.umkc.solr.search.QParser;
import edu.umkc.solr.search.Sorting;
...
public abstract class FieldType extends FieldProperties {
  ...
  /**
   * A "polyField" is a FieldType that can produce more than one IndexableField instance for a single value, via the {@link #createFields(edu.umkc.solr.schema.SchemaField, Object, float)} method.  This is useful
   ...
   * @return true if the {@link #createFields(edu.umkc.solr.schema.SchemaField, Object, float)} method may return more than one field
   */
...
//            + propertiesToString(properties)
  ...
  /**
   * Given a {@link edu.umkc.solr.schema.SchemaField}, create one or more {@link org.apache.lucene.index.IndexableField} instances
   * @param field the {@link edu.umkc.solr.schema.SchemaField}
   ...
   *
   * @param parser       the {@link edu.umkc.solr.search.QParser} calling the method
  ...
  /**
   * Returns a Query instance for doing range searches on this field type. {@link edu.umkc.solr.search.SolrQueryParser}
   ...
   * @param parser The {@link edu.umkc.solr.search.QParser} calling the method
   * @param field The {@link edu.umkc.solr.schema.SchemaField} of the field to search
  ...
  /**
   * Check's {@link edu.umkc.solr.schema.SchemaField} instances constructed 
