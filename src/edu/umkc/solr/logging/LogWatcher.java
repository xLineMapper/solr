...
import edu.umkc.solr.logging.jul.JulWatcher;
import edu.umkc.solr.logging.log4j.Log4jWatcher;
...
public abstract class LogWatcher<E> {
   ...
   */
  public static LogWatcher newRegisteredLogWatcher(LogWatcherConfig config, ISolrResourceLoader loader) {
  ...
  private static LogWatcher createWatcher(LogWatcherConfig config, ISolrResourceLoader loader) {
