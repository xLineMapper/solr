...
public abstract class AbstractPluginLoader<T>
{
  ...
  protected T create( ISolrResourceLoader loader, String name, String className, Node node ) throws Exception
  {
   ...
   * 
   */
  public T load( ISolrResourceLoader loader, NodeList nodes )
  {
   ...
   * 
   */
  public T loadSingle(ISolrResourceLoader loader, Node node) {
    List<PluginInitInfo> info = new ArrayList<>();
    T plugin = null;
