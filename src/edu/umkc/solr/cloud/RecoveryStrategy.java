...
import edu.umkc.solr.update.PeerSync;
import edu.umkc.solr.update.UpdateLog;
import edu.umkc.solr.update.UpdateLog.RecoveryInfo;
import edu.umkc.solr.update.processor.DistributedUpdateProcessor;
...
public class RecoveryStrategy extends Thread implements ClosableThread {
  ...
  public RecoveryStrategy(ICoreContainer cc, CoreDescriptor cd, RecoveryListener recoveryListener) {
    this.cc = cc;
  ...
  private void recoveryFailed(final ISolrCore core,
  ...
  private void replicate(String nodeName, ISolrCore core, ZkNodeProps leaderprops)
  ...
  public void run() {
    ...
    try (ISolrCore core = cc.getCore(coreName)) {
  ...
  public void doRecovery(ISolrCore core) throws KeeperException, InterruptedException {
  ...
  private Future<RecoveryInfo> replay(ISolrCore core)
