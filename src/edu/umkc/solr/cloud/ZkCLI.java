    ...
    try {
      ...
      try {
        ...
        if (line.getOptionValue(CMD).equals(BOOTSTRAP)) {
          ...
          final ISolrResourceLoader loader = new SolrResourceLoaderImp(solrHome);
          ICoreContainer cc = new CoreContainerImp(SolrXmlConfig.fromSolrHome(loader, loader.getInstanceDir()));
