...
public class CloudUtil {
   ...
   */
  public static void checkSharedFSFailoverReplaced(ICoreContainer cc, CoreDescriptor desc) {
   ...
   */
  public static String unifiedResourcePath(ISolrResourceLoader loader) {
