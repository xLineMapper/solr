...
public class SyncStrategy {
  ...
  public SyncStrategy(ICoreContainer cc) {
  ...
  public boolean sync(ZkController zkController, ISolrCore core, ZkNodeProps leaderProps) {
    return sync(zkController, core, leaderProps, false);
  }
  
  public boolean sync(ZkController zkController, ISolrCore core, ZkNodeProps leaderProps, boolean peerSyncOnlyWithActive) {
  ...
  private boolean syncReplicas(ZkController zkController, ISolrCore core,
  ...
  private boolean syncWithReplicas(ZkController zkController, ISolrCore core,
