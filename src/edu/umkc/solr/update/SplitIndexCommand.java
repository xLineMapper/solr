...
public class SplitIndexCommand extends UpdateCommand {
  ...
  public List<ISolrCore> cores;  // either paths or cores should be specified
  public List<DocRouter.Range> ranges;
  public DocRouter router;
  public String routeFieldName;
  public String splitKey;

  public SplitIndexCommand(SolrQueryRequest req, List<String> paths, List<ISolrCore> cores, List<DocRouter.Range> ranges, DocRouter router, String routeFieldName, String splitKey) {
    super(req);
    this.paths = paths;
    this.cores = cores;
    this.ranges = ranges;
