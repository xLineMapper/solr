...
import edu.umkc.solr.core.SolrConfig.UpdateHandlerInfo;
...
import edu.umkc.solr.search.FunctionRangeQuery;
...
import edu.umkc.solr.search.function.ValueSourceRangeFilter;
...
public class DirectUpdateHandler2 extends UpdateHandler implements SolrCoreState.IndexWriterCloser {
  ...
  public DirectUpdateHandler2(ISolrCore core) {
    super(core);
  ...
  public DirectUpdateHandler2(ISolrCore core, UpdateHandler updateHandler) {
