...
import static edu.umkc.solr.update.processor.DistributedUpdateProcessor.DistribPhase.FROMLEADER;
...
public class PeerSync  {
  ...
  public PeerSync(ISolrCore core, List<String> replicas, int nUpdates) {
    this(core, replicas, nUpdates, false, true);
  }
  
  public PeerSync(ISolrCore core, List<String> replicas, int nUpdates, boolean cantReachIsSuccess, boolean getNoVersionsIsSuccess) {
    this(core, replicas, nUpdates, cantReachIsSuccess, getNoVersionsIsSuccess, false);
  }
  
  public PeerSync(ISolrCore core, List<String> replicas, int nUpdates, boolean cantReachIsSuccess, boolean getNoVersionsIsSuccess, boolean onlyIfActive) {
  ...
  public static void sync(ISolrCore core, List<String> replicas, int nUpdates) {
