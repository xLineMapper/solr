...
import edu.umkc.solr.core.MapSerializable;
...
import static edu.umkc.solr.core.Config.assertWarnOrFail;
...
public class SolrIndexConfig implements MapSerializable {
  ...
  private static class DelayedSchemaAnalyzer extends DelegatingAnalyzerWrapper {
    ...
    public DelayedSchemaAnalyzer(ISolrCore core) {
  ...
  public IndexWriterConfig toIndexWriterConfig(ISolrCore core) {
