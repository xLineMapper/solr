...
public final class UpdateRequestProcessorChain implements PluginInfoInitialized
{
  ...
  public UpdateRequestProcessorChain(ISolrCore solrCore) {
  ...
  public static UpdateRequestProcessorChain constructChain(UpdateRequestProcessorChain defaultUrp,
                                                           ProcessorInfo processorInfo, ISolrCore core) {
  ...
  static List<UpdateRequestProcessorFactory> getReqProcessors(String processor, ISolrCore core) {
