...
import static edu.umkc.solr.update.processor.FieldMutatingUpdateProcessorFactory.SelectorParams;
...
public abstract class FieldMutatingUpdateProcessor 
  ...
  public static FieldNameSelector createFieldNameSelector
    (final ISolrResourceLoader loader,
     final ISolrCore core,
  ...
  private static final class ConfigurableFieldNameSelectorHelper {
    ...
    private ConfigurableFieldNameSelectorHelper(final ISolrResourceLoader loader,
                                          final SelectorParams params) {
      this.params = params;
