...
public final class LoadAdminUiServlet extends BaseSolrServlet {
  ...
  public void doGet(HttpServletRequest request,
    ...
    ICoreContainer cores = (CoreContainerImp) request.getAttribute("edu.umkc.solr.CoreContainer");
    ...
    if(in != null && cores != null) {
      try {
        ...
        String[] replace = new String[] {
            ...
            StringEscapeUtils.escapeJavaScript(CoreContainerImp.CORES_HANDLER_PATH),
