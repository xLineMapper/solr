...
public class NodeConfig {
  ...
  private NodeConfig(String nodeName, String coreRootDirectory, String configSetBaseDirectory, String sharedLibDirectory,
                     ...
                     ISolrResourceLoader loader, Properties solrProperties) {
  ...
  public ISolrResourceLoader getSolrResourceLoader() {
    return loader;
  }
  ...
  public static class NodeConfigBuilder {
    ...
    private final ISolrResourceLoader loader;
    private final String nodeName;
    ...
    private static final String DEFAULT_ADMINHANDLERCLASS = "edu.umkc.solr.handler.admin.CoreAdminHandler";
    private static final String DEFAULT_INFOHANDLERCLASS = "edu.umkc.solr.handler.admin.InfoHandler";
    private static final String DEFAULT_COLLECTIONSHANDLERCLASS = "edu.umkc.solr.handler.admin.CollectionsHandler";

    public NodeConfigBuilder(String nodeName, ISolrResourceLoader loader) {
      this.nodeName = nodeName;
      this.loader = loader;
