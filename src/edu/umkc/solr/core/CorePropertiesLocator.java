...
public class CorePropertiesLocator implements CoresLocator {
  ...
  private void discoverUnder(File root, List<CoreDescriptor> cds, ICoreContainer cc) {
  ...
  protected CoreDescriptor buildCoreDescriptor(File propertiesFile, ICoreContainer cc) {
