...
public class CoreDescriptor {
   ...
   */
  public CoreDescriptor(ICoreContainer container, String name, String instanceDir,
                        Properties coreProps) {
    this(container, name, instanceDir, coreProps, null);
  }

  public CoreDescriptor(ICoreContainer container, String name, String instanceDir, String... properties) {
  ...
  private static String convertToAbsolute(String instDir, String solrHome) {
    ...
    return SolrResourceLoaderImp.normalizeDir(Paths.get(solrHome).resolve(instDir).toString());
  }
