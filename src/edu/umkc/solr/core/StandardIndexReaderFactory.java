...
public class StandardIndexReaderFactory extends IndexReaderFactory {
  ...
  @Override
  public DirectoryReader newReader(Directory indexDir, ISolrCore core) throws IOException {
    return DirectoryReader.open(indexDir);
  }

  @Override
  public DirectoryReader newReader(IndexWriter writer, ISolrCore core) throws IOException {
