...
public abstract class IndexReaderFactory implements NamedListInitializedPlugin {
   ...
   */
  public abstract DirectoryReader newReader(Directory indexDir, ISolrCore core)
      throws IOException;
   ...
   * @throws IOException If there is a low-level I/O error.
   */
  public abstract DirectoryReader newReader(IndexWriter writer, ISolrCore core)
      throws IOException;
}
