...
public interface ISolrIndexSearcherFactory
{
  public abstract SolrIndexSearcher createSolrIndexSearcher(ISolrCore core, String path, IndexSchema schema, String name, DirectoryReader r,
